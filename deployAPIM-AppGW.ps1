...
$resGroupName = "new-apgw-apim-rg" # resource group name
$location = "UK South"           # Azure region
New-AzResourceGroup -Name $resGroupName -Location $location

# Create subnet config for Application Gateway
$appgatewaysubnet = New-AzVirtualNetworkSubnetConfig -Name "man-appgw-subnet" -AddressPrefix "10.0.0.0/24"

# Create subnet config for API-M
$apimsubnet = New-AzVirtualNetworkSubnetConfig -Name "man-apim-subnet" -AddressPrefix "10.0.1.0/24"

# Create VNET and assign subnets
$vnet = New-AzVirtualNetwork -Name "apgw-apim-myvnet-vnet" -ResourceGroupName $resGroupName -Location $location -AddressPrefix "10.0.0.0/16" -Subnet $appgatewaysubnet,$apimsubnet
...
$gatewayCertPfxPassword = "123abc"   # password for api.yourdomain.co.uk pfx certificate
$portalCertPfxPassword = "123abc"    # password for portal.yourdomain.co.uk pfx certificate
...
$publicip = New-AzPublicIpAddress -ResourceGroupName $resGroupName -name "man-appgw-pip" -location $location -AllocationMethod Dynamic

# Create Application Gateway configuration
# step 1 - create App GW IP config
$gipconfig = New-AzApplicationGatewayIPConfiguration -Name "man-gatewayIP" -Subnet $appgatewaysubnetdata

# step 2 - configure the front-end IP port for the public IP endpoint
$fp01 = New-AzApplicationGatewayFrontendPort -Name "man-frontend-port443" -Port 443

# step 3 - configure the front-end IP with the public IP endpoint
$fipconfig01 = New-AzApplicationGatewayFrontendIPConfig -Name "man-frontend1" -PublicIPAddress $publicip

# step 4 - configure certs for the App Gateway
$cert = New-AzApplicationGatewaySslCertificate -Name "man-apim-gw-cert01" -CertificateFile $gatewayCertPfxPath -Password $certPwd
$certPortal = New-AzApplicationGatewaySslCertificate -Name "man-apim-portal-cert01" -CertificateFile $portalCertPfxPath -Password $certPortalPwd

# step 5 - configure HTTP listeners for the App Gateway
$listener = New-AzApplicationGatewayHttpListener -Name "man-apim-gw-listener01" -Protocol "Https" -FrontendIPConfiguration $fipconfig01 -FrontendPort $fp01 -SslCertificate $cert -HostName $gatewayHostname -RequireServerNameIndication true
$portalListener = New-AzApplicationGatewayHttpListener -Name "man-apim-portal-listener02" -Protocol "Https" -FrontendIPConfiguration $fipconfig01 -FrontendPort $fp01 -SslCertificate $certPortal -HostName $portalHostname -RequireServerNameIndication true

# step 6 - create custom probes for API-M endpoints
$apimprobe = New-AzApplicationGatewayProbeConfig -Name "man-apim-gw-proxyprobe" -Protocol "Https" -HostName $gatewayHostname -Path "/status-0123456789abcdef" -Interval 30 -Timeout 120 -UnhealthyThreshold 8
$apimPortalProbe = New-AzApplicationGatewayProbeConfig -Name "man-apim-portal-probe" -Protocol "Https" -HostName $portalHostname -Path "/signin" -Interval 60 -Timeout 300 -UnhealthyThreshold 8

# step 7 - upload cert for SSL-enabled backend pool resources
$authcert = New-AzApplicationGatewayAuthenticationCertificate -Name "man-whitelistcert1" -CertificateFile $gatewayCertCerPath

# step 8 - configure HTTPs backend settings for the App Gateway
$apimPoolSetting = New-AzApplicationGatewayBackendHttpSettings -Name "man-apim-gw-poolsetting" -Port 443 -Protocol "Https" -CookieBasedAffinity "Disabled" -Probe $apimprobe -AuthenticationCertificates $authcert -RequestTimeout 180
$apimPoolPortalSetting = New-AzApplicationGatewayBackendHttpSettings -Name "man-apim-portal-poolsetting" -Port 443 -Protocol "Https" -CookieBasedAffinity "Disabled" -Probe $apimPortalProbe -AuthenticationCertificates $authcert -RequestTimeout 180

# step 9a - configure back-end IP address pool with internal IP of API-M i.e. 10.0.1.5
$apimProxyBackendPool = New-AzApplicationGatewayBackendAddressPool -Name "man-apimbackend" -BackendIPAddresses $apimService.PrivateIPAddresses[0]

# step 9b - create sinkpool for API-M requests we want to discard 
$sinkpool = New-AzApplicationGatewayBackendAddressPool -Name "man-sinkpool"

# step 10 - create a routing rule to allow external Internet access to the developer portal
$rule01 = New-AzApplicationGatewayRequestRoutingRule -Name "man-apim-portal-rule01" -RuleType Basic -HttpListener $portalListener -BackendAddressPool $apimProxyBackendPool -BackendHttpSettings $apimPoolPortalSetting
...
$listener = Get-AzApplicationGatewayHttpListener -Name "man-apim-gw-listener01" -ApplicationGateway $appgw
$sinkpool = Get-AzApplicationGatewayBackendAddressPool -ApplicationGateway $appgw -Name "man-sinkpool"
$pool = Get-AzApplicationGatewayBackendAddressPool -ApplicationGateway $appgw -Name "man-apimbackend"
$poolSettings = Get-AzApplicationGatewayBackendHttpSettings -ApplicationGateway $appgw -Name "man-apim-gw-poolsetting"
